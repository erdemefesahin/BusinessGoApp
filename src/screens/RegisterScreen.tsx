          ...
          <ScrollView 
            ...
            <Animated.View style={[styles.contentContainer, { opacity: fadeAnim }]}>
              ...
              <Animated.View 
                ...
                <Text style={styles.subtitle}>Join RestaurantGO and discover amazing restaurants</Text>
              </Animated.View>
              ...
              <Animated.View
                ...
                <View style={styles.socialContainer}>
                  ...
                  <TouchableOpacity 
                    ...
                    activeOpacity={0.8}
                    onPress={() => console.log('Facebook register pressed')}>
                  ...
                  <TouchableOpacity 
                    ...
                    activeOpacity={0.8}
                    onPress={() => console.log('Apple register pressed')}>
